...
[LOWER_LAYER] = { /* Raphael LOWER */
  ...
  {KC_TRNS, FUNC(SOFT_COLEMAK_LAYER), FUNC(HARD_COLEMAK_LAYER), LSFT(RSFT(KC_PAUSE)), KC_TRNS, KC_TRNS, KC_TRNS, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS},
...
[RAISE_LAYER] = { /* Raphael RAISE */
  ...
  {KC_TRNS, FUNC(SOFT_COLEMAK_LAYER), FUNC(HARD_COLEMAK_LAYER), LSFT(RSFT(KC_PAUSE)), KC_TRNS, KC_TRNS, KC_TRNS, S(KC_MINS), S(KC_EQL),  S(KC_LBRC), S(KC_RBRC), S(KC_BSLS)},
